...
def Image():
    url = "https://hmtai.hatsunia.cfd/v2/hentai"
...
class SlashHentai(commands.Cog):
    def __init__(self, client):
        self.client = client


    @app_commands.command(name="hentai")
    ...
    async def on_ready(self):
        self.client.tree.add_command(self.hentai)
        self.client.tree.sync()

async def setup(client):
    await client.add_cog(SlashHentai(client))