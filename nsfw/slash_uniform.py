...
def Image():
    url = "https://hmtai.hatsunia.cfd/v2/uniform"
...
class SlashUniform(commands.Cog):
    ...
    async def uniform(self, interaction: discord.Interaction):
        ...
        print(f"{interaction.user} uniform")
    @commands.Cog.listener()
    async def on_ready(self):
        self.client.tree.add_command(self.uniform)
        self.client.tree.sync()

async def setup(client):
    await client.add_cog(SlashUniform(client))