...
class SlashCum(commands.Cog):
    def __init__(self, client):
        self.client = client


    @app_commands.command(name="cum", description="Envia uma imagem de jatada")
    ...
    async def on_ready(self):
        self.client.tree.add_command(self.cum)
        self.client.tree.sync()

async def setup(client):
    await client.add_cog(SlashCum(client))